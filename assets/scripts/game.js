...
const mobileBrowser = isItMobileBrowser(
...
let bullets,
  ...
  bulletCounter,
  bulletLimitCounter,
  bulletLimitCounterInverse,
  finalBulletCounter;
let enemyColumnCount,
  enemyRowCount,
  enemyPadding,
  enemyOffsetLeft,
  enemyOffsetTop,
  enemies,
  enemyDirection,
  enemyIncreasedXSpeed,
  enemyIncreasedYSpeed,
  enemyIncreasedXSpeedBy,
  enemyIncreasedYSpeedBy,
  enemyCounter,
  enemyLeftCounter,
  enemiesProtected;
let enemyBulletCounter,
  enemyBullets,
  shoot,
  enemiesShootDelayCounter,
  enemyBulletImageWidth,
  enemyBulletImageHeight;
let totalBulletsShotText,
  totalBulletsHitText,
  totalEnemyBulletsShotText,
  bulletsLimitReachedText,
  runOutOfLivesText;
let shooterImage,
  shieldImage,
  enemyBulletImage,
...
function initGameText(theme) {
  if (theme === "covid") {
    ...
    runOutOfLivesText =
      "You've had too many close contacts, mandatory quarantine!";
  }
}
...
function drawInstructions() {
  ...
  if (
    canvasWidth > keyboardImage.width &&
    canvasHeight > keyboardImage.height * 2
  ) {
    drawPreInstructions(20);
    ctx.drawImage(
      keyboardImage,
      canvasWidth / 2 - keyboardImage.width / 2,
      canvasHeight / 2 - keyboardImage.height / 2
    );
...
function drawPreInstructions(y) {
  ...
  ctx.fillText(
    "Instructions",
    canvasWidth / 2,
    canvasHeight / 2 - keyboardImage.height + 40 + y
  );
  ctx.fillText(
    "D or right arrow to move right",
    canvasWidth / 2,
    canvasHeight / 2 - keyboardImage.height + 60 + y
  );
  ctx.fillText(
    "A or left arrow to move left",
    canvasWidth / 2,
    canvasHeight / 2 - keyboardImage.height + 80 + y
  );
  ctx.fillText(
    "Space bar to shoot",
    canvasWidth / 2,
    canvasHeight / 2 - keyboardImage.height + 100 + y
  );
  ctx.fillText(
    "S to activate the shield",
    canvasWidth / 2,
    canvasHeight / 2 - keyboardImage.height + 120 + y
  );
  ctx.fillText(
    "F to activate moving fast",
    canvasWidth / 2,
    canvasHeight / 2 - keyboardImage.height + 140 + y
  );
  ctx.fillText(
    "P to pause and R to retry",
    canvasWidth / 2,
    canvasHeight / 2 - keyboardImage.height + 160 + y
  );
}
...
function drawPostInstructions(y) {
  if (mobileBrowser) {
    ...
    ctx.fillText(
      "To start the game pick your theme",
      canvasWidth / 2,
      canvasHeight / 2 + keyboardImage.height - 140 + y
    );
    ctx.fillText(
      "↪ Press 1 for Operation Vaccination Theme",
      canvasWidth / 2,
      canvasHeight / 2 + keyboardImage.height - 100 + y
    );
  }
...
function initGame() {
  ...
  shooter = new Shooter(
    ...
    shooterExtraSpeed,
    bulletSpeed,
    protectionFramesNumber,
    moveFastFramesNumber
  );
...
function createEnemies() {
  const enemyCharecterOne1 = {
    image: enemyImageOne1,
    score: 1,
    special: false,
  };
  const enemyCharecterOne2 = {
    image: enemyImageOne2,
    score: 1,
    special: false,
  };
  const enemyCharecterOne3 = {
    image: enemyImageOne6,
    score: 10,
    special: true,
  };
  const enemyCharecterOne4 = {
    image: enemyImageOne3,
    score: 1,
    special: false,
  };
  const enemyCharecterOne5 = {
    image: enemyImageOne4,
    score: 1,
    special: false,
  };
  const enemyCharecterOne6 = {
    image: enemyImageOne5,
    score: 1,
    special: false,
  };
  const enemyCharectersCategoryOne = [
    enemyCharecterOne1,
    enemyCharecterOne2,
    enemyCharecterOne3,
    enemyCharecterOne4,
  ...
  const enemyCharecterTwo1 = {
    image: enemyImageTwo1,
    score: 2,
    special: false,
  };
  const enemyCharecterTwo2 = {
    image: enemyImageTwo2,
    score: 2,
    special: false,
  };
  const enemyCharecterTwo3 = {
    image: enemyImageTwo3,
    score: 2,
    special: false,
  };
  const enemyCharecterTwo4 = {
    image: enemyImageTwo4,
    score: 2,
    special: false,
  };
  const enemyCharecterTwo5 = {
    image: enemyImageTwo5,
    score: 2,
    special: false,
  };
  const enemyCharecterTwo6 = {
    image: enemyImageTwo6,
    score: 2,
    special: false,
  };
  const enemyCharectersCategoryTwo = [
    enemyCharecterTwo1,
    enemyCharecterTwo2,
    enemyCharecterTwo3,
    enemyCharecterTwo4,
  ...
  const enemyCharecterThree1 = {
    image: enemyImageThree1,
    score: 3,
    special: false,
  };
  const enemyCharecterThree2 = {
    image: enemyImageThree2,
    score: 3,
    special: false,
  };
  const enemyCharecterThree3 = {
    image: enemyImageThree3,
    score: 3,
    special: false,
  };
  const enemyCharecterThree4 = {
    image: enemyImageThree4,
    score: 3,
    special: false,
  };
  const enemyCharecterThree5 = {
    image: enemyImageThree5,
    score: 3,
    special: false,
  };
  const enemyCharecterThree6 = {
    image: enemyImageThree6,
    score: 3,
    special: false,
  };
  const enemyCharectersCategoryThree = [
    enemyCharecterThree1,
    enemyCharecterThree2,
    enemyCharecterThree3,
    enemyCharecterThree4,
    enemyCharecterThree5,
    enemyCharecterThree6,
  ];
  const enemyCategories = [
    enemyCharectersCategoryOne,
    enemyCharectersCategoryTwo,
    enemyCharectersCategoryThree,
  ];
  ...
  for (let c = 0; c < enemyColumnCount; c++) {
    for (let r = 0; r < enemyRowCount; r++) {
      ...
      const initMiddlePosition =
        canvasWidth / 2 -
        (enemyColumnCount * enemyWidth) / 2 -
        enemyWidth / 2 +
        enemyOffsetLeft;
      const x =
        c * (enemyWidth + enemyPadding) + enemyOffsetLeft + initMiddlePosition;
  ...
  if (!enemyLeftCounter) {
    if ((score * enemyCounter) / finalBulletCounter === score) {
      ...
      ctx.fillText(
        "Perfect Score!!! 🎉",
        canvasWidth / 2,
        canvasHeight / 2 - winningImage.height / 2 - 100
      );
      ctx.fillStyle = "#FFFFFF";
    }
    ctx.fillText(
      "Well Done",
      canvasWidth / 2,
      canvasHeight / 2 - winningImage.height / 2 - 60
    );
    ctx.fillText(
      "Press R to Play again",
      canvasWidth / 2,
      canvasHeight / 2 - winningImage.height / 2 - 20
    );
    ctx.drawImage(
      winningImage,
      canvasWidth / 2 - winningImage.width / 2,
      canvasHeight / 2 - winningImage.height / 2
    );
    ctx.fillText(
      totalBulletsShotText + finalBulletCounter,
      canvasWidth / 2,
      canvasHeight / 2 + winningImage.height - 120
    );
    ctx.fillText(
      totalBulletsHitText + enemyCounter,
      canvasWidth / 2,
      canvasHeight / 2 + winningImage.height - 80
    );
    ctx.fillText(
      "Your score is: " +
        Math.ceil((score * enemyCounter) / finalBulletCounter) +
        " out of " +
        score,
      canvasWidth / 2,
      canvasHeight / 2 + winningImage.height - 40
    );
    ctx.fillText(
      totalEnemyBulletsShotText + enemyBulletCounter,
      canvasWidth / 2,
      canvasHeight / 2 + winningImage.height
    );
    ...
    !lives ||
    beaten ||
    (bulletLimitCounterInverse === 0 && Object.keys(bullets).length === 0) ||
    gameIsOver
  ) {
    ctx.fillText(
      "Game Over",
      canvasWidth / 2,
      canvasHeight / 2 - losingImage.height / 2 - 60
    );
    ctx.fillText(
      "Press R to Retry",
      canvasWidth / 2,
      canvasHeight / 2 - losingImage.height / 2 - 20
    );
    ctx.drawImage(
      losingImage,
      canvasWidth / 2 - losingImage.width / 2,
      canvasHeight / 2 - losingImage.height / 2
    );
    if (bulletLimitCounterInverse === 0) {
      ctx.fillText(
        bulletsLimitReachedText,
        canvasWidth / 2,
        canvasHeight / 2 + losingImage.height - 180
      );
    } else if (!lives) {
      ctx.fillText(
        runOutOfLivesText,
...
function handleShooter() {
  ...
  if (shooter.protected) {
    ...
    ctx.fillText(
      Math.floor(
        (shooter.protectionCounter * 100) / shooter.protectionFramesNumber
      ) + "%",
      shooter.x - 45,
      shooter.y + shooter.height / 2
    );
  ...
  if (shooter.moveFast) {
    ...
    ctx.fillText(
      Math.floor(
        (shooter.moveFastCounter * 100) / shooter.moveFastFramesNumber
      ) + "%",
      shooter.x - 45,
      shooter.y + shooter.height / 2 + 40
    );
...
function handleCollisions() {
  ...
  if (!gameIsOver) {
    ...
    if (bonus.isLive() && bonus.isActivated()) {
      if (
        bonus.x + bonusImage.width >= shooter.x &&
        bonus.x <= shooter.x + shooter.width &&
        (bonus.y - bonusImage.height >= shooter.y || bonus.y >= shooter.y) &&
        (bonus.y - bonusImage.height <= shooter.y + shooter.height ||
          bonus.y <= shooter.y + shooter.height)
      ) {
        bonus.status = false;
...
class Bonus {
  ...
  _generateRandomX() {
    return (
      Math.floor(Math.random() * (canvasWidth - this.shooterWidth)) +
      this.shooterWidth
    );
  }
}
